    ...
    <el-card v-loading="loading" shadow="never">
      ...
      <div class="table-wrapper">
        <el-table :data="tableData">
          ...
          <el-table-column prop="username" label="密码" align="center" />
          <el-table-column prop="username" label="头像" align="center" />
          <el-table-column prop="createTime" label="登录时间" align="center" />
          <el-table-column prop="username" label="登录IP" align="center" />
          <el-table-column prop="username" label="投顾编号" align="center" />
          <el-table-column prop="username" label="姓名" align="center" />
          <el-table-column fixed="right" label="操作" width="80" align="center">
            <template #default="scope">
              <el-button type="danger" text bg size="small" @click="handleChangeStatus(scope.row)">
                禁用
              </el-button>
            </template>
          </el-table-column>
...
// #region 禁用/启用
function handleChangeStatus(row: TableData) {
  const action = row.status === 0 ? "启用" : "禁用"
  ElMessageBox.confirm(`是否${action}用户：${row.username}，确认操作？`, "提示", {
